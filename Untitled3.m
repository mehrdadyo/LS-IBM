figure(3)
contourf(DOMAIN.Xp,DOMAIN.Yp,(StateVar.phi<0).*StateVar.phi.*(LS.psi>0), 50, 'LineStyle', 'none'); colormap jet
hold on
...
contourf(DOMAIN.Xp,DOMAIN.Yp,(LSinit.psi), 50, 'LineStyle', 'none'); colormap jet
