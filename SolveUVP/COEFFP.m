...
AE = -d_u(2:imax-1,2:jmax).*dyv(2:imax-1,1:jmax-1);
      
AW = -d_u(2:imax-1,2:jmax).*dyv(2:imax-1,1:jmax-1);
      
AN = -d_v(2:imax,2:jmax-1).*dxu(1:imax-1,2:jmax-1);
      
AS = -d_v(2:imax,2:jmax-1).*dxu(1:imax-1,2:jmax-1);
...
%     S_p(2:imax,2) =  d_v(2:imax,2).*dyv(2:imax,2);
% 
% elseif BC_s_p == 3 
%     AN_s = -d_v(2:imax,2).*dxu(1:imax-1,2);
% end
...
a_p(2:imax,2:jmax) = -(a_w(2:imax,2:jmax) + a_e(2:imax,2:jmax) +...
                        a_s(2:imax,2:jmax) + a_n(2:imax,2:jmax)) + ...
                        S_p(2:imax,2:jmax);
