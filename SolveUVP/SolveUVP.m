...
%      for kk=1:10
        ...
        [Soln.CM_p,Soln.CM_p2, ap, aw, ae, as, an, Sp] = ...
            COEFFP(Soln.d_u,Soln.d_v,BC,DOMAIN, ControlVar);
        %% Solve U- momentum
...
%===================== old v momentum solver ==============================        
        ...
        [Soln.RHS_P,Soln.RHS_P2] = RHSP(U_star,V_star,...
            DOMAIN,IBM_coeffU,IBM_coeffV, ControlVar);
...
%             ControlVar.maxit,Soln.L_p,Soln.U_p);
        ...
        [Soln.PCOR] = FORMPCOR(StateVar.P_cor_vec,DOMAIN, ControlVar);
...
%         P_star=P;
        ...
        if ControlVar.PISO == 1
            ...
            [Soln.RHS_P_pr,Soln.RHS_P2_pr] = RHSP_PISO(Soln,U_star,...
                V_star,DOMAIN,IBM_coeffU,IBM_coeffV, ControlVar);
            [StateVar.P_cor_vec,Soln.f,Soln.ress,Soln.it,Soln.resvec] = ...
